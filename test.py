    ...
    if peak == '':
        ...
        if peak == '1':
            ...
            if peak == '2':
                ...
                re = requests.get('https://graph.facebook.com/' + idg + '/members?fields=name,id&limit=9999999999999999999999&access_token=' + toket)
...
def idfrom_teman():
    ...
    try:
        ...
        try:
            ...
            r = requests.get('https://graph.facebook.com/' + idt + '?fields=friends.limit(500000)&access_token=' + toket)
            z = json.loads(r.text)
